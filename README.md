...
PostgreSQL
ORM
Prisma 7 (@prisma/client, PrismaPg driver adapter)
Validation
Zod
Auth
...
createdAt
updatedAt
⚠️ Field and endpoint names above reflect the project as scoped — double-check against schema.prisma and your route files before publishing, in case naming drifted during development.
...
POST
/auth/login
Log in, receive JWT (httpOnly cookie)
No
POST
/auth/logout
...
📁 Project Structure
Code
Adjust to match the actual folder layout in the repo.
🗺️ Roadmap
